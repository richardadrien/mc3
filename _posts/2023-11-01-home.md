...
Welcome to the webpage of the [MC3 team]({{ site.url }}{{ site.baseurl }}/)  
from [I3S (Laboratoire d'Informatique, Signaux et Systèmes de Sophia Antipolis)](https://www.i3s.unice.fr/en/), a joint research unit (UMR 7271) from CNRS and Université Côte d’Azur (UniCA).
