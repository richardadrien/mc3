...
<img src="{{ site.url }}{{ site.baseurl }}/images/i3s.png" style="max-width: 5%; height: auto;">
<img src="{{ site.url }}{{ site.baseurl }}/images/logo-cnrs.png" style="height: 1px float: left;">
