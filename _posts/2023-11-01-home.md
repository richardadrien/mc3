...
<p>
<img src="{{ site.url }}{{ site.baseurl }}/images/i3s.png" style="max-width: 28%; height: auto; float:left;">
<img src="{{ site.url }}{{ site.baseurl }}/images/logo-cnrs.png" style="max-width: 28%; height: auto; float:left;">
<img src="{{ site.url }}{{ site.baseurl }}/images/UCA-Logo-2niveaux-RVB.png" style="max-width: 35%; height: auto; padding-bottom: 5em;">
</p>
<br>
