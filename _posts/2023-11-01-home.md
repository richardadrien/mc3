...
<img src="{{ site.url }}{{ site.baseurl }}/images/i3s.png" style="height: 15px float: left;">
<img src="{{ site.url }}{{ site.baseurl }}/images/logo-cnrs.png" style="height: 15px float: left;">
