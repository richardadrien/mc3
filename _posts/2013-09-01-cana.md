...
* [funkdigen2](https://github.com/aeporreca/funkdigen2) : An efficient generator of functional digraphs (also known as finite dynamical systems) up to isomorphism.
* [JS-Sandpile](https://github.com/huacayacauh/JS-Sandpile) :
  JavaScript implementation of the [Abelian sandpile model](https://en.wikipedia.org/wiki/Abelian_sandpile_model).  
  Click and play in your browser!
* [Secure Exchange Protocol (SXP)](http://github.com/pja35/SXP) :
  An open, ubiquitous, peer-to-peer, secure protocol suite for multi-party exchanges of contracts.
